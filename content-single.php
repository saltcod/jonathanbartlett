	...
	<footer class="entry-meta">
		<?php
			...
			if ( ! toolbox_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'Posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'toolbox' );
				} else {
					$meta_text = __( 'Posted in %1$s. <a href="%3$s" title="Permalink to %4$s" rel="bookmark">Permalink</a>.', 'toolbox' );
				}
