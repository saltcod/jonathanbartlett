...
function xx_load_my_scripts() {
    ...
    wp_register_script( 'jonathanbartlett', get_template_directory_uri() .'/js/jonathanbartlett.js');
    wp_enqueue_script( 'jonathanbartlett' );
...
function toolbox_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline">  </span>', 'toolbox' ),
